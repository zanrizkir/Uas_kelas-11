  ...
  <body >
        ...
        <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            <div  class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <li class="nav-item active">
                    <a class="nav-link px-2 shadow-sm bg-body rounded" style="background-color : rgb(151, 151, 151);" href="index.php" href="index.php">Pendaftaran <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link d-block  " href="../pembayaran/index.php">Pembayaran <span class="sr-only">(current)</span></a>
                </li>
                </ul>
            </div>
            </nav>
        ...
        <center>
            <h2 class="h2"  style='font-weight: bolder'>Data Pendaftaran</h2>
        ...
        <div class="width: 95%">
                ...
                <!-- TABLE Jurusan -->
                <table class="table mx-auto table-bordered text-center shadow p-3 mb-5 bg-body rounded cellpadding="20px" style="width: fit-content">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
