            ...
            <span class="d-block w-50 bg-secondary rounded mx-auto" style="height: 2px"></span>
                <form action="../pendaftaran/proses.php" method="post" class="d-flex p-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" name="kode_pendaftaran" required
                            placeholder="Masukan Kode Pendaftaran " value="<?php echo $kode_pendaftaran; ?>">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Nama</label>
                        <input type="text" required class="form-control" name="nama" required
                            placeholder="Masukan Nama Siswa" value="<?php echo $nama; ?>">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Tempat Lahir</label>
                        <input type="text" class="form-control" name="tempat_lahir" required
                            placeholder="Masukan Tempat Lahir" value="<?php echo $tempat_lahir; ?>">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Jenis Kelamin</label> </b><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" required id="inlineRadio1"
                                value="laki-laki" value="<?php echo $jenis_kelamin; ?>">
                            <label class="form-check-label" for="inlineRadio1">Laki-laki</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" required id="inlineRadio2"
                                value="perempuan">
