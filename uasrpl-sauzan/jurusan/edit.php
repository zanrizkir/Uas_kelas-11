            ...
            ?>
                <form action="../jurusan/proses.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><b> Kode Jurusan</label>
                        <input type="text" class="form-control" name="kode_jurusan"
                            value="<?php echo $kode_jurusan; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jurusan </b></label>
                        <input type="text" class="form-control" name="jurusan" required value="<?php echo $jurusan; ?>">
                    </div>
